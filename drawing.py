...
# setting up images for the game
class Drawing:
    ...
    # setting up main menu or background
    def background(self):
    ...
    # setting up mini map coordinates
    def mini_map(self):
    ...
    def menu(self):
        ...
        while self.menu_trigger:
            ...
            color = randrange(40)
            label = label_font.render('DEAD RUN', 1, (color, color, color))
